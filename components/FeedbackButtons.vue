...
<template>
    ...
    <div v-show="textBoxShown" class="absolute top-0 left-0 w-full h-full flex items-center justify-center">
        <div class="h-2/4 w-2/6 bg-neutral-300 flex flex-col items-center">
            ...
            <textarea v-model="userInput" placeholder="Please provide feedback on the message above (250 chars)"
                maxlength="250" class="my-6 h-1/4 w-3/4 text-wrap"></textarea>
            <div class="my-4">
            ...
            <UButton icon="i-heroicons-x-mark" size="sm" color="" variant="solid" :trailing="false" label="Close"
                @click="close()" />
        </div>
    </div>
